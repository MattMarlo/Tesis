...
/*
|--------------------------------------------------------------------------
| Webhook público de prerreservas
|--------------------------------------------------------------------------
*/
...
Route::middleware('auth')
    ->group(function () {
        ...
        Route::prefix('usuarios')
            ->middleware(
                'check.permission:usuarios.administrar'
            )
            ->group(function () {
                Route::get(
                    '/',
        ...
        Route::prefix('reservas')
            ->group(function () {
                ...
                Route::get(
                    '/riesgo',
                    [
                        ReservaRiesgoController::class,
                        'index',
                    ]
                )->name('reservas.riesgo');
                ...
                /*
                 * Ruta temporal de seguridad.
                 *
                 * Se conserva el nombre porque la vista
                 * actual todavía lo utiliza, pero ya no
                 * permite cancelar directamente.
                 */
                Route::patch(
                    '/{reserva}/cancelar',
                    function (
                        ...
                        return response()->json(
                            [
                                ...
                                'message' =>
                                    'La cancelación directa fue deshabilitada. Debes crear una solicitud de cancelación para revisión.',
                            ],
                            409
                        );
                    }
         ...
         */
        Route::prefix('cancelaciones')
            ->name('cancelaciones.')
            ->group(function () {
                Route::get(
                    '/solicitudes',
                    [
                        SolicitudCancelacionController::class,
                        'index',
                    ]
                )->name(
                    'solicitudes.index'
                ...
                Route::get(
                    '/solicitudes/{solicitud}/evidencia',
                    [
                        SolicitudCancelacionController::class,
                        'descargarEvidencia',
                    ]
        ...
        Route::prefix('operaciones')
            ...
            ->group(function () {
                Route::get(
                    '/',
                    [
                        OperacionViajeController::class,
                        'index',
                    ]
                )->name('index');
                ...
                Route::post(
                    ...
                    [
                        ViajeroReservaController::class,
                        'sincronizarTitular',
                    ]
                )->name('viajeros.titular');

                Route::post(
                    '/expediente/{operacion}/viajeros',
                    [
                        ViajeroReservaController::class,
                        'store',
                    ]
                ...
                Route::post(
                    '/expediente/{operacion}/vuelos',
                    [
                        VueloReservaController::class,
                        'store',
                    ]
                )->name('vuelos.store');
                ...
                Route::post(
                    ...
                    [
                        AlojamientoReservaController::class,
                        'store',
                    ]
                )->name(
                    'alojamientos.store'
                ...
                Route::post(
                    ...
                    [
                        HabitacionAlojamientoController::class,
                        'store',
                    ]
                )->name(
                    'habitaciones.store'
                ...
                Route::post(
                    '/habitaciones/{habitacion}/asignaciones',
                    [
                        HabitacionAlojamientoController::class,
                        'asignar',
                    ]
                ...
                Route::delete(
                    '/asignaciones-habitacion/{asignacion}',
                    [
                        HabitacionAlojamientoController::class,
                        'retirar',
                    ]
                )->name(
                    'habitaciones.retirar'
                );

                Route::post(
                    '/expediente/{operacion}/guias',
                    [
                        GuiaReservaController::class,
                        'store',
                    ]
                )->name('guias.store');
        ...
        Route::prefix(
            ...
            Route::get(
                '/create',
                [
                    ReservaIndividualController::class,
                    'create',
                ]
            )->name(
